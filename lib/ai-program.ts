...
export const aiProgram: Record<Locale, ProgramCopy> = {
  es: {
    ...
    stages: [
      {
        ...
        profile: "No técnico",
        objective: "Empezar con Codex sin programar, entender qué puede hacer una IA, qué no debe hacer sola y cómo trabajar con privacidad, fuentes y revisión humana.",
        courses: ["codex-desde-cero", "ia-pymes"],
    ...
    tracks: [
      { id: "no-tecnico", title: "Perfil no técnico", audience: "Pymes, docentes, estudiantes, operaciones y creadores", entry: "Empieza con Codex desde cero; no necesitas terminal ni saber programar.", outcome: "Automatizar trabajo real o publicar una primera web con revisión humana y privacidad.", stages: ["alfabetizacion", "herramientas", "construccion", "capstone"] },
