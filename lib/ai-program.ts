...
export const aiProgram: Record<Locale, ProgramCopy> = {
  es: {
    ...
    stages: [
      {
        ...
        profile: "No técnico",
        objective: "Entender qué puede hacer una IA, qué no debe hacer sola y cómo trabajar con privacidad, fuentes y revisión humana.",
      ...
      },
      {
        ...
        objective: "Crear herramientas con RAG, modelos locales, APIs compatibles, interfaz mínima, logs y manejo de errores.",
    ...
    tracks: [
      { id: "no-tecnico", title: "Perfil no técnico", audience: "Pymes, docentes, operaciones, creadores", entry: "Empieza por alfabetización y negocio.", outcome: "Automatizar trabajo real con revisión humana y privacidad.", stages: ["alfabetizacion", "herramientas", "construccion", "capstone"] },
