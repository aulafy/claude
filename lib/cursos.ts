...
export const cursos: Curso[] = [
  {
    ...
    short: "Agentes open source con Cordis, plugins, sesiones y perfiles",
    desc: "Entiende el harness de agentes de DeepSeek, instala DSH con seguridad, configura modelos DeepSeek y aprende a diseñar flujos auditables con modos, plugins, workspaces, subagentes, métricas y perfiles.",
  ...
  },
  {
    ...
    desc: "Curso fundamental para aprender inteligencia artificial con criterio: modelos, chat, RAG, agentes, contexto, verificación, privacidad, herramientas y un primer proyecto propio. Es el punto de partida del itinerario completo de Aulafy.",
    level: "Cero absoluto",
    updatedAt: "2026-08-04",
    icon: "sparkle",
    ...
    secciones: [
      {
        ...
        lecciones: [
          ...
          { slug: "lm-studio-desde-cero", title: "LM Studio desde cero" },
  ...
  },
  {
    ...
    secciones: [
      ...
      {
        title: "Producción y observabilidad aplicada",
        lecciones: [
          { slug: "evals-logs", title: "Evals, logs y observabilidad" },
          { slug: "observabilidad-agentes-locales", title: "Laboratorio: mapa de observabilidad" },
          { slug: "setup-langfuse-ollama", title: "Setup: Langfuse y Ollama" },
          { slug: "traza-basica-ollama", title: "Primera traza con Ollama" },
          { slug: "rag-trazabilidad", title: "RAG con trazabilidad" },
          { slug: "tools-loops-trazables", title: "Tools, permisos y loops trazables" },
          { slug: "evals-scores-langfuse", title: "Evals y scores con Langfuse" },
          { slug: "privacidad-produccion-observabilidad", title: "Privacidad, costes y producción" },
          { slug: "analizar-trazas", title: "Cómo leer y diagnosticar trazas" },
