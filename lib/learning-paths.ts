  ...
  es: [
    {
      ...
      description: "Entiende la IA generativa, úsala con criterio y consigue un primer resultado antes de elegir una herramienta o especialización.",
      audience: "Personas sin experiencia técnica, estudiantes y profesionales curiosos",
      entry: "Cero absoluto",
      firstStep: "IA desde cero",
      duration: "1–4 semanas",
      outcome: "Completar una tarea de bajo riesgo con datos permitidos, comprobación humana y un criterio claro para elegir la siguiente especialización.",
      courses: ["ia-desde-cero", "codex-desde-cero"],
      featured: true,
    },
    {
      slug: "web-saas",
