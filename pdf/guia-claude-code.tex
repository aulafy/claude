...
% Permitir que las URLs largas se partan en cualquier punto
\usepackage{xurl}
% Permitir que el código en línea (\texttt) se parta para que no se salga del margen
\usepackage{seqsplit}
...
Si tienes sugerencias, dudas o quieres proponer mejoras para esta guía, puedes escribir a \mbox{\href{mailto:learntouseai@gmail.com}{learntouseai@gmail.com}}.
