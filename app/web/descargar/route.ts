...
export async function GET() {
  ...
  </style></head><body><main><header class="cover"><b>AULAFY · EDICIÓN HTML DESCARGABLE</b><h1>IA desde cero</h1><p>Curso fundamental para aprender inteligencia artificial con criterio, práctica y evidencias.</p><div class="meta">12 lecciones · revisado el 4 de agosto de 2026 · CC BY 4.0</div></header>${content}<footer><hr><p>Fuente: <a href="https://www.aulafy.net/web">aulafy.net/web</a> · Comprueba en línea si existe una versión más reciente.</p></footer></main></body></html>`;
