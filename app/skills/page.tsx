...
/deploy produccion`}</code></pre>
      ...
      <div className="mt-12 pt-8 border-t border-zinc-800 flex justify-between items-center">
        <Link href="/avanzado" className="text-sm text-zinc-500 hover:text-zinc-300">← Uso avanzado</Link>
        <Link href="/subagentes" className="text-sm text-orange-400 hover:text-orange-300">Subagentes →</Link>
      </div>
    </div>
  );
}
