        ...
        <div className="flex flex-col lg:flex-row lg:items-start gap-8">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-4 aula-meta text-zinc-600">
              Sin registro, cookies ni seguimiento personal. El avance básico se guarda solo en este navegador. <a href={`#progress-${curso.slug}`} className="text-cyan-300 hover:text-cyan-200">Cómo funciona la privacidad.</a>
            </p>
          </div>
