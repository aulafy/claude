...
Aulafy is a free, independent and open bilingual AI learning portal. Its continuous course contains 7 modules, 28 lessons and 7 integrated projects, while its extended library offers specialized paths and tutorials. It progresses from foundations to RAG, software, local models, agents, safety and production, with an emphasis on evidence, privacy and human review.
