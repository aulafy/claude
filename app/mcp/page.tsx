...
# Servidor remoto (HTTP/SSE)
{
  ...
  "headers": { "Authorization": "Bearer TOKEN" }
      ...
      <div className="mt-12 pt-8 border-t border-zinc-800 flex justify-between items-center">
        <Link href="/configuracion" className="text-sm text-zinc-500 hover:text-zinc-300">← Configuración</Link>
        <Link href="/hooks" className="text-sm text-orange-400 hover:text-orange-300">Hooks →</Link>
      </div>
    </div>
  );
}
