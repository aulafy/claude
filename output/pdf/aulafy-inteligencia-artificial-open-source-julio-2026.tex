...
\usepackage[a4paper,inner=24mm,outer=18mm,top=22mm,bottom=23mm]{geometry}
\usepackage{xcolor,hyperref,booktabs,longtable,fancyhdr,microtype,titlesec,tcolorbox,fvextra,xurl,fontspec}
...
\hypersetup{colorlinks=true,linkcolor=teal,urlcolor=orange}
...
{\sffamily\bfseries\Huge Aulafy: Inteligencia Artificial Open Source\par}\vspace{7mm}
{\Large Manual practico para aprender, construir y automatizar con IA\par}\vspace{5mm}
{\sffamily\bfseries Julio 2026\par}\vfill
\end{titlepage}
