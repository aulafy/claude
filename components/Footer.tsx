...
const copy = {
  es: {
    ...
    links: [["/cursos", "Aprender"], ["/cursos/ia-pymes", "Trabajo y pymes"], ["/curso-codex-espanol", "Construir"], ["/buscar", "Buscar"], ["/fuentes", "Fuentes"], ["/acerca", "Acerca de Aulafy"]],
  ...
  en: {
    ...
    links: [["/en/courses", "Learn"], ["/en/courses/ia-pymes", "Work & business"], ["/en/courses/codex-programadores", "Build"], ["/en/search", "Search"], ["/fuentes", "Sources"], ["/acerca", "About Aulafy"]],
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 py-8">
        ...
        <div className="mt-7 pt-5 border-t border-[var(--border)] flex flex-col sm:flex-row gap-3 sm:items-center justify-between">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs">
            ...
            <Link href={locale === "en" ? "/en/feed.xml" : "/feed.xml"} className="text-[var(--muted)] hover:text-[var(--accent)]">RSS</Link>
