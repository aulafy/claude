-- Añade retornos reales a instalaciones que ya aplicaron las migraciones anteriores.
...
alter table private.learning_event_daily
  add constraint learning_event_daily_name_check check (event_name in (
    ...
    'continue_return', 'return_7d', 'return_30d', 'feedback_useful',
    'task_open', 'external_source_open'
  ));
